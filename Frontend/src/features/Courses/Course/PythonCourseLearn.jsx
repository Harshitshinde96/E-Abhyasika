...
export default function PythonCourseLearn() {
  ...
  const [notes, setNotes] = useState([
    {
      ...
      completed: false,
      resources: [
        { type: "pdf", title: "Python Basics PDF", url: "/resources/python-basics.pdf" },
        { type: "code", title: "Sample Code", url: "/resources/python-intro-code.zip" }
      ]
    },
    {
      id: 2,
      title: "Setting up Python Environment",
      content: "Install Python, set up virtual environments, and configure your IDE...",
      completed: false,
      resources: [
        { type: "video", title: "Installation Guide", url: "/resources/python-installation.mp4" },
        { type: "link", title: "Python Download", url: "https://www.python.org/downloads/" }
      ]
    },
    {
      id: 3,
      ...
      completed: false,
      resources: [
        { type: "pdf", title: "Syntax Cheat Sheet", url: "/resources/python-syntax.pdf" },
        { type: "code", title: "Practice Exercises", url: "/resources/python-exercises.zip" }
      ]
    }
  ]);
  ...
  const [courseSections] = useState([
    {
      ...
      lessons: [
        { id: 1, title: "Introduction to Python", duration: "30 min", completed: false },
    ...
    },
    {
      ...
      lessons: [
        { id: 7, title: "Lists and Tuples", duration: "60 min", completed: false },
        { id: 8, title: "Dictionaries", duration: "45 min", completed: false },
        { id: 9, title: "Sets", duration: "50 min", completed: false }
      ]
    }
  ]);
    ...
    <div className="min-h-screen bg-white px-6 py-10 text-gray-800">
      <header className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Welcome to your Python learning journey! This comprehensive course is
          crafted for absolute beginners and covers everything from setting up
          your development environment to building powerful applications with
        ...
        <div className="space-y-4">
          <div className="aspect-video rounded-lg overflow-hidden shadow-xl border">
            <video
              ...
              src="https://example.com/python-course-video.mp4"
              title="Python Course"
            ></video>
          </div>
              ...
              <div className="divide-y">
                {section.lessons.map((lesson) => (
                  <div key={lesson.id} className="p-4 flex justify-between items-center">
                    ...
                    <Link
                      to={`/course/python/lesson/${lesson.id}`}
